...
part 'product_put_response_model.g.dart';

@JsonSerializable()
class ProductPutResponseModel {
  ...
  factory ProductPutResponseModel.fromJson(Map<String, dynamic> json) =>
      _$ProductPutResponseModelFromJson(json);

  Map<String, dynamic> toJson() => _$ProductPutResponseModelToJson(this);
}
