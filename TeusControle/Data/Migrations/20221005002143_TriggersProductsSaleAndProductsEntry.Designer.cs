...
namespace Data.Migrations
{
    ...
    [Migration("20221005002143_TriggersProductsSaleAndProductsEntry")]
    partial class TriggersProductsSaleAndProductsEntry
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Domain.ProductSale", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("TotalOutPrice")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("decimal(65,30)")
                        .HasComputedColumnSql("Amount * UnitOutPrice", true);
                    ...
                    b.Property<decimal>("UnitOutPrice")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("decimal(65,30)")
                        .HasComputedColumnSql("UnitPrice - Discount", true);
                    ...
                    b.ToTable("products_sale");
                });

            modelBuilder.Entity("Core.Domain.Sale", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Domain.ProductSale", b =>
                {
                    ...
                    b.HasOne("Core.Domain.Sale", "Sale")
                        .WithMany("ProductsSale")
                        .HasForeignKey("Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
